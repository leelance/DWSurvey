...
public class JsonUtils {
   ...
   * @return T
   */
  public static <T> HttpResult<T> parse2R(String json, Class<T> clazz) {
    JavaType javaType = OBJECT_MAPPER.getTypeFactory().constructParametricType(HttpResult.class, clazz);
    try {
      return OBJECT_MAPPER.readValue(json, javaType);
    } catch (IOException e) {
      log.warn("json -> list<T> fail: ", e);
